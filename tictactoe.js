function StartGame()
{
    ...
    document.getElementById("s5").style.color = "blue ";
    document.getElementById("s6").style.color = "blue ";
    document.getElementById("s7").style.color = "blue ";
    document.getElementById("s8").style.color = "blue ";
    document.getElementById("s9").style.color = "blue ";
}
